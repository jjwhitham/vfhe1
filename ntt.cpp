...
constexpr u32 POLY_SIZE = 8;
constexpr u128 FIELD_MOD = 17;
constexpr u128 NTH_ROU = 2;
constexpr u128 TWO_ROU = 3;
constexpr u128 GROUP_MOD = 103;
// p = k * q + 1
constexpr u128 K = 6;
...
void ntt_iter_(arr2n_u128& x, const arr_u128& w) {
...
void ntt_iter(arr2n_u128& x, const arr_u128& rou_pows) {
    ntt_iter_(x, rou_pows);
}
void intt_iter(arr2n_u128& x, const arr_u128& rou_pows, u128 inv_x_len) {
    ntt_iter(x, rou_pows);
    // scale by N^-1
    for (auto& el : x)
